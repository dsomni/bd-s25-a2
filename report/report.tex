...
The results of benchmarking are shown in \Cref{fig:queies_run}.
...
\begin{figure}[hbthbt]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot coordinates {(Q1, 0.850) (Q2, 1.043)};
            \addplot coordinates {(Q1, 19.379) (Q2, 18.895)};
            \addplot coordinates {(Q1, 8.662) (Q2, 3.743)};

            \legend{PostgreSQL,MongoDB,Neo4j}
        \end{axis}
    \end{tikzpicture}
